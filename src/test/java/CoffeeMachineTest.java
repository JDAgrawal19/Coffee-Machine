...
public class CoffeeMachineTest {
    ...
    public void tearDown() {
        coffeeMachine.reset();
        resetSingleton(CreateCoffeeMachine.class, "coffeeMachine");
    }
    ...
    public void test3OutletsValidInput() throws Exception {
        ...
        File file = new File(CreateCoffeeMachine.class.getClassLoader().getResource(filePath).getFile());
        String jsonInput = FileUtils.readFileToString(file, "UTF-8");
        coffeeMachine = CreateCoffeeMachine.getInstance(jsonInput);
